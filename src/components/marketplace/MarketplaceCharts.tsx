/**
 * Campus Marketplace — Chart Visualizations
 *
...
import { MarketplaceTrend } from './marketplaceTypes';
...
export const TrendLine: React.FC<{
  ...
  title: string;
  lines: { key: keyof MarketplaceTrend; color: string; label: string }[];
}> = ({ trends, title, lines }) => {
  ...
  return (
    <div style={{ background: '#fff', borderRadius: 12, padding: 16, border: '1px solid #e5e7eb', textAlign: 'center' }}>
      ...
      <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
        ...
        <polygon points={poly} fill="#f59e0b30" stroke="#f59e0b" strokeWidth={2} />
