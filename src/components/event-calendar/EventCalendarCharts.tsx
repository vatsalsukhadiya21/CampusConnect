/**
 * Campus Event Calendar — Chart Visualizations
 *
...
import { EventTrend, ClubActivity } from './eventCalendarTypes';
...
export const TrendLine: React.FC<{
  trends: EventTrend[];
  title: string;
  lines: { key: keyof EventTrend; color: string; label: string }[];
}> = ({ trends, title, lines }) => {
  ...
  return (
    <div style={{ background: '#fff', borderRadius: 12, padding: 16, border: '1px solid #e5e7eb', textAlign: 'center' }}>
      ...
      <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
        ...
        <polygon points={poly} fill="#8b5cf630" stroke="#8b5cf6" strokeWidth={2} />
